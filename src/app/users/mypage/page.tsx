...
export default function MyPage({ params }: { params: { page: string } }) {
  ...
  const { data: comments, refetch } = useQuery({ queryKey: [`comments-${page}`], queryFn: fetchComments })
  ...
  return (
    <div className='md:max-w-5xl mx-auto px-4 py-8'>
      ...
      <div className='mt-8 px-4 sm:px-0'>
        <h3 className='text-base font-semibold leading-7 text-gray-900'>내가 쓴 댓글</h3>
