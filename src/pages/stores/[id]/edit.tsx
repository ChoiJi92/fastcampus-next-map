...
export default function StoreEditPage() {
  ...
  const {
    ...
    isSuccess,
    isError,
  } = useQuery({ queryKey: [`store-${id}`], queryFn: fetchStore, refetchOnWindowFocus: false })
  if (isSuccess) {
  ...
  return (
    <form
      ...
      onSubmit={handleSubmit(async data => {
        try {
          const result = await axios.put('/api/stores', { ...data, id: store?.id })
            ...
            <div className='sm:col-span-3'>
              ...
              <div className='mt-2'>
                <input
                  ...
                  className='block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 px-2 outline-none placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6'
                />
            ...
            <div className='sm:col-span-2'>
              ...
              <div className='mt-2'>
                <select
                  ...
                  className='block w-full rounded-md border-0 py-2 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-4000 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6'
                >
